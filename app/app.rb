class JavascriptMuenchenDe < Padrino::Application
  configure do
    ##
    ...
    sponsor_list = []
    #                            Name                Image                        CSS class      Link URL
    sponsor_list << Sponsor.new('Moriz GmbH',       '/images/moriz_logo.png',     '',           'http://www.moriz.de/')
    sponsor_list << Sponsor.new('Rails.io Ruby Hosting',  '/images/rails_io.png', '',           'http://rails.io/')

    set :sponsors, sponsor_list
